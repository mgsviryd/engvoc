    ...
    export default{
        ...
        methods: {
            fetchData(){
                ...
                if (this.favorite.sort != null) {
                    this.currentSort = this.favorite.sort
                } else {
            ...
            clickSort(sort){
                this.$store.dispatch('favoriteSetSortAction', sort)
                let products = [...this.favorite.products]
                let sorted = this.sortInSortOrder(products, sort.property, sort.direction, sort.typeMark)
                this.$store.dispatch('favoriteUpdateAction', sorted)
            },
            firstCapital(lower){
