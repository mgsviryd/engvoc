    ...
    export default{
        ...
        methods: {
            fetchData(){
                ...
                if (this.recent.sort != null) {
                    this.currentSort = this.recent.sort
                } else {
            ...
            clickSort(sort){
                this.$store.dispatch('recentSetSortAction', sort)
                let products = [...this.recent.products]
                let sorted = this.sortInSortOrder(products, sort.property, sort.direction, sort.typeMark)
                this.$store.dispatch('recentUpdateAction', sorted)
            },
            firstCapital(lower){
